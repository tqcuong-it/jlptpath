---
title: "Bài 22: 連体修飾 — Mệnh đề quan hệ trong tiếng Nhật"
slug: "bai-22-rentai-shuushoku-menh-de-quan-he"
date: 2023-02-05
description: "Học mệnh đề bổ nghĩa danh từ (V plain + N), cấu trúc ～とき và ～と (điều kiện tự nhiên) theo Minna no Nihongo bài 22"
...
|---|---|---|---|
| きります | きります | Mặc (quần áo) | コートを きります。 |
| ぬぎます | ぬぎます | Cởi (quần áo) | くつを ぬぎます。 |
| かぶります | かぶります | Đội (mũ) | ぼうしを かぶります。 |
| かけます | かけます | Đeo (kính) | めがねを かけます。 |
| うまれます | うまれます | Được sinh ra | とうきょうで うまれました。 |
| コート | こーと | Áo khoác | あたらしい コートを かいました。 |
| きもの | きもの | Kimono | きものを きている ひと |
| くつ | くつ | Giày | くろい くつを はいています。 |
| ぼうし | ぼうし | Mũ/Nón | あかい ぼうしを かぶっています。 |
| ネクタイ | ねくたい | Cà vạt | ネクタイを しています。 |
| めがね | めがね | Kính | めがねを かけている ひと |
| セーター | せーたー | Áo len | あおい セーターを きています。 |
| スーツ | すーつ | Bộ vest | スーツを きている ひと |

{{< audio-player src="/audio/n5/22_-_1_-_Kotoba.mp3" title="🔊 Nghe từ vựng bài 22" >}}
...
💡 **Lưu ý quan trọng:** Trong mệnh đề, **が** thay cho **は**:
- ❌ わたし**は** すんでいる まち
- ✅ わたし**が** すんでいる まち
...
- **こども**の とき、よく この こうえんで あそびました。→ **Khi còn nhỏ**, tôi hay chơi ở công viên này.
...
- はるに なる**と**、さくらが さきます。→ **Khi** đến mùa xuân, hoa anh đào nở.
- この ボタンを おす**と**、ドアが あきます。→ **Khi** bấm nút này, cửa mở.
- みぎへ まがる**と**、えきが あります。→ **Khi** rẽ phải, có nhà ga.

💡 **Lưu ý:** ～と **không dùng** cho ý chí, mệnh lệnh, lời mời sau vế sau.

{{< audio-player src="/audio/n5/22_-_2_-_Bunkei.mp3" title="🔊 Nghe mẫu câu" >}}
{{< audio-player src="/audio/n5/22_-_3_-_Reibun.mp3" title="🔊 Nghe ví dụ" >}}
...
{{< audio-player src="/audio/n5/22_-_4_-_Kaiwa.mp3" title="🔊 Nghe hội thoại" >}}

## 4. Bài tập

**Câu 1:** Nối thành câu: "Người đang đeo kính kia là ai?"

{{< spoiler "Đáp án" >}}めがねを かけている ひとは だれですか。{{< /spoiler >}}

**Câu 2:** Dịch: "Khi đến mùa đông, trời lạnh."

{{< spoiler "Đáp án" >}}ふゆに なると、さむく なります。{{< /spoiler >}}

**Câu 3:** Điền vào: にほんへ いく＿、おみやげを かいます。

{{< spoiler "Đáp án" >}}とき{{< /spoiler >}}

**Câu 4:** Sửa lỗi sai: わたしは すんでいる まちは しずかです。

{{< spoiler "Đáp án" >}}わたし**が** すんでいる まちは しずかです。（Trong mệnh đề bổ nghĩa, は → が）{{< /spoiler >}}

**Câu 5:** Dịch: "Quyển sách tôi đọc hôm qua rất thú vị."

{{< spoiler "Đáp án" >}}きのう わたしが よんだ ほんは とても おもしろかったです。{{< /spoiler >}}

{{< audio-player src="/audio/n5/22_-_5_-_Renshuu_C1.mp3" title="🔊 Luyện tập C1" >}}
{{< audio-player src="/audio/n5/22_-_6_-_Renshuu_C2.mp3" title="🔊 Luyện tập C2" >}}
{{< audio-player src="/audio/n5/22_-_7_-_Renshuu_C3.mp3" title="🔊 Luyện tập C3" >}}
...
|---|---|---|---|
| 着 | き（ます） | Mặc | 着ます = mặc |
| 脱 | ぬ（ぎます） | Cởi | 脱ぎます = cởi |
| 生 | う（まれます） | Sinh | 生まれます = được sinh ra |
| 時 | とき | Thời, lúc | ～時 = khi |
| 町 | まち | Phố, thành phố | 町 = thành phố |

---

✨ Bài tiếp theo: [Bài 23: ～とき — Khi...](/jlpt/n5/bai-23-toki-khi/)

## 🎧 Bài nghe kiểm tra

{{< audio-player src="/audio/n5/22_-_8_-_Mondai_1.mp3" title="🔊 問題1 — Nghe và trả lời" >}}

{{< audio-player src="/audio/n5/22_-_9_-_Mondai_2.mp3" title="🔊 問題2 — Nghe và trả lời" >}}
