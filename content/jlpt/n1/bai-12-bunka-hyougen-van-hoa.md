---
title: "Bài 12: 文化的表現 — Biểu hiện văn hóa Nhật Bản"
slug: "bai-12-bunka-hyougen-van-hoa"
date: 2023-05-12
description: "Hiểu sâu văn hóa Nhật qua ngôn ngữ: tatemae/honne, kuuki wo yomu, omotenashi và các concept văn hóa độc đáo chỉ có ở Nhật"
...
| Concept | Kanji | Nghĩa | Usage |
|---|---|---|---|
| **建前** | たてまえ | Lời nói công khai, nguyên tắc | 社会的な場面で使う |
| **本音** | ほんね | Tâm tư thật, ý kiến thực | 親しい間柄で明かす |
...
**Cultural Context:**
「彼は空気が読めないから、みんな困っている。」
→ Anh ấy không biết đọc tình huống nên mọi người đều khó khăn.
...
**Business Context:**
「お客様第一のおもてなしで有名な会社です。」
→ Công ty nổi tiếng về tinh thần phục vụ khách hàng hàng đầu.

## 2. 日本社会の特徴 (Đặc điểm xã hội Nhật)

### 2.1 集団主義 vs 個人主義

| Japanese | Reading | Nghĩa | Context |
|---|---|---|---|
| 和を重んじる | わをたっとぶ | Coi trọng sự hòa hợp | 日本の伝統的価値観 |
| 個性を大切にする | こせいをたいせつにする | Coi trọng cá tính | 現代の価値観変化 |
| 出る杭は打たれる | でるくいはうたれる | Cây cao bị gió bật | 集団圧力の表現 |
| 同調圧力 | どうちょうあつりょく | Áp lực đồng điệu | 社会現象 |
...
**Modern Applications:**
「世間体を気にして、本当の気持ちを言えない。」
→ Quan tâm thể diện nên không nói được cảm xúc thật.
...
{{< spoiler "Đáp án" >}}建前: lời nói công khai/nguyên tắc; 本音: suy nghĩ thật/cảm xúc thật{{< /spoiler >}}

**Câu 2:** 「空気を読む」はどういう意味ですか？

{{< spoiler "Đáp án" >}}tình huống を理解して適切に行動すること{{< /spoiler >}}

**Câu 3:** 「おもてなし」の特徴は？

{{< spoiler "Đáp án" >}}見返りを期待しない、心からのサービス精神{{< /spoiler >}}

**Câu 4:** 「出る杭は打たれる」の意味は？

{{< spoiler "Đáp án" >}}目立つ人は批判される/集団から圧力を受ける{{< /spoiler >}}

**Câu 5:** 現代日本の働き方改革について述べてください。

{{< spoiler "Đáp án" >}}長時間労働から ワークライフバランス重視へ変化している{{< /spoiler >}}
...
🏯 **Cultural Mastery Keys:**
**Context sensitivity** (状況判断) + **Indirect communication** (間接表現) + **Social harmony** (社会調和) + **Seasonal awareness** (季節感) = **True N1 Cultural Understanding**

✨ Bài tiếp theo: [Bài 13: 複雑構文 — Cấu trúc câu phức tạp](/jlpt/n1/bai-13-fukuzatsu-koubun-cau-phuc-tap/)

## 🎧 Audio bài học

{{< audio-player src="/audio/n1/CD-B/shinkanzen_chokai_n1_CD-B_002.mp3" title="会話 💬 Hội thoại bài 12" >}}

{{< audio-player src="/audio/n1/CD-B/shinkanzen_chokai_n1_CD-B_003.mp3" title="問題 ✏️ Bài nghe 1 — Nghe và trả lời câu hỏi" >}}

{{< audio-player src="/audio/n1/CD-B/shinkanzen_chokai_n1_CD-B_004.mp3" title="問題 ✏️ Bài nghe 2 — Nghe và trả lời câu hỏi" >}}

{{< audio-player src="/audio/n1/CD-B/shinkanzen_chokai_n1_CD-B_005.mp3" title="問題 ✏️ Bài nghe 3 — Nghe và trả lời câu hỏi" >}}

{{< audio-player src="/audio/n1/CD-B/shinkanzen_chokai_n1_CD-B_006.mp3" title="問題 ✏️ Bài nghe 4 — Nghe và trả lời câu hỏi" >}}

{{< audio-player src="/audio/n1/CD-B/shinkanzen_chokai_n1_CD-B_007.mp3" title="問題 ✏️ Bài nghe 5 — Nghe và trả lời câu hỏi" >}}

{{< audio-player src="/audio/n1/CD-B/shinkanzen_chokai_n1_CD-B_008.mp3" title="問題 ✏️ Bài nghe 6 — Nghe và trả lời câu hỏi" >}}
