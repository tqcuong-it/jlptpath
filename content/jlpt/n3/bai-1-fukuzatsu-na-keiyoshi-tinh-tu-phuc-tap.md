---
title: "Bài 1: 複雑な形容詞 — Tính từ phức tạp và cách sử dụng nâng cao"
slug: "bai-1-fukuzatsu-na-keiyoshi-tinh-tu-phuc-tap"
date: 2023-03-01
description: "Học cách sử dụng tính từ phức tạp trong tiếng Nhật N3: い/な kết hợp, tính từ kép, và cách biểu đạt cảm xúc, đánh giá tinh tế"
...
**な + 名詞:** 
- 複雑**な**問題 → vấn đề phức tạp
- 具体的**な**計画 → kế hoạch cụ thể
- 個人的**な**意見 → ý kiến cá nhân

**の + 名詞:** (khi nhấn mạnh sở hữu/liên quan)
- 個人**の**意見 → ý kiến của cá nhân
- 一般**の**人 → người bình thường
...
最近、日本の職場環境について**複雑な**問題が話題になっている。**一般的に**、日本の会社は**独特な**文化を持っているが、若い世代には**不適切な**慣習も多い。特に、**個人的な**時間を犠牲にする風習は**深刻な**問題だと考えられている。

**具体的な**解決策を見つけるのは難しいが、**現実的な**改革が必要だ。**曖昧な**ルールではなく、**明確な**ガイドラインを作ることが**適切な**対応だろう。この問題は**微妙な**側面があるため、**慎重な**検討が必要である。
...
**Câu 1:** Chọn tính từ phù hợp: この計画は＿＿すぎて、実現できません。
a) 単純 b) 複雑 c) 明確 d) 具体的

{{< spoiler "Đáp án" >}}b) 複雑{{< /spoiler >}}

**Câu 2:** Dịch sang tiếng Nhật: "Nói chung thì đây là một vấn đề nghiêm trọng."

{{< spoiler "Đáp án" >}}一般的に言えば、これは深刻な問題です。{{< /spoiler >}}

**Câu 3:** Điền vào chỗ trống: ＿＿的には、この方法が一番いいと思います。
a) 個人 b) 一般 c) 具体 d) 抽象

{{< spoiler "Đáp án" >}}a) 個人{{< /spoiler >}}

**Câu 4:** Chọn nghĩa đúng của "微妙な関係": 
a) Mối quan hệ rõ ràng b) Mối quan hệ tinh tế c) Mối quan hệ phức tạp d) Mối quan hệ đơn giản

{{< spoiler "Đáp án" >}}b) Mối quan hệ tinh tế{{< /spoiler >}}

**Câu 5:** Sắp xếp: 問題 / 深刻な / です / これは

{{< spoiler "Đáp án" >}}これは深刻な問題です。{{< /spoiler >}}
...
✨ Bài tiếp theo: [Bài 2: 敬語の基礎 — Cơ bản về kính ngữ](/jlpt/n3/bai-2-keigo-no-kiso-co-ban-kinh-ngu/)

## 🎧 Audio bài học

{{< audio-player src="/audio/n3/chukyu1_lesson10_CD39.mp3" title="会話 💬 Hội thoại bài 1" >}}

{{< audio-player src="/audio/n3/chukyu1_lesson10_CD41.mp3" title="問題 ✏️ Bài nghe 1 — Nghe và trả lời câu hỏi" >}}

{{< audio-player src="/audio/n3/chukyu1_lesson10_CD42.mp3" title="問題 ✏️ Bài nghe 2 — Nghe và trả lời câu hỏi" >}}
