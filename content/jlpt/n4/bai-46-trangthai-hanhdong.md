---
title: "Bài 46: ～ところです・～ばかりです — Trạng thái hành động"
slug: "bai-46-trangthai-hanhdong"
date: 2023-03-01
description: "Học cách diễn đạt trạng thái hành động với ～ところです và ～ばかりです. Nắm vững cách biểu hiện thời điểm của hành động"
...
{{< audio-player src="/audio/n4/46_-_2_-_Bunkei.mp3" title="🔊 Nghe mẫu câu" >}}
{{< audio-player src="/audio/n4/46_-_3_-_Reibun.mp3" title="🔊 Nghe ví dụ" >}}
...
>
> **B：** それは おつかれさまでした。コーヒーでも いかがですか。**いれたばかりです**から、あついですよ。
>
> **A：** ありがとうございます。いただきます。ところで、あたらしい しごとは どうですか。
>
> **B：** **はじめたばかりです**から、まだ なれていませんが、おもしろいです。いま **おぼえているところです**。
...
{{< audio-player src="/audio/n4/46_-_4_-_Kaiwa.mp3" title="🔊 Nghe hội thoại" >}}

## 4. Bài tập

**Câu 1:** Chọn đáp án đúng: 今___食べるところです。
a) から b) を c) に

{{< spoiler "Đáp án" >}}a) から（これから食べる）{{< /spoiler >}}

**Câu 2:** Dịch sang tiếng Nhật: "Tôi vừa mới đến Nhật Bản."

{{< spoiler "Đáp án" >}}にほんに きたばかりです。{{< /spoiler >}}

**Câu 3:** Hoàn thành câu: 宿題を___ところです。（đang làm）

{{< spoiler "Đáp án" >}}している{{< /spoiler >}}

**Câu 4:** Chọn dạng đúng: 映画が終わった___です。（vừa xong）
a) ところ b) ばかり c) tất cả đều đúng

{{< spoiler "Đáp án" >}}c) tất cả đều đúng（nhưng nghĩa hơi khác）{{< /spoiler >}}

**Câu 5:** Điền từ thích hợp: 毎日遊んで___いる。

{{< spoiler "Đáp án" >}}ばかり（chỉ toàn）{{< /spoiler >}}

{{< audio-player src="/audio/n4/46_-_5_-_Renshuu_C1.mp3" title="🔊 Luyện tập C1" >}}
{{< audio-player src="/audio/n4/46_-_6_-_Renshuu_C2.mp3" title="🔊 Luyện tập C2" >}}
{{< audio-player src="/audio/n4/46_-_7_-_Renshuu_C3.mp3" title="🔊 Luyện tập C3" >}}
...
✨ Bài tiếp theo: [Bài 47: ～そうです・～らしいです — Truyền đạt và đánh giá](/jlpt/n4/bai-47-dentatsu-danhgia/)

## 🎧 Bài nghe kiểm tra

{{< audio-player src="/audio/n4/46_-_8_-_Mondai_1.mp3" title="🔊 問題1 — Nghe và trả lời" >}}

{{< audio-player src="/audio/n4/46_-_9_-_Mondai_2.mp3" title="🔊 問題2 — Nghe và trả lời" >}}