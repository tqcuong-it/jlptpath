---
title: "Bài 42: はずです・べきです — Kỳ vọng và nghĩa vụ"
slug: "bai-42-kibo-gimu"
date: 2023-02-25
description: "Học cách thể hiện kỳ vọng với はずです và nghĩa vụ với べきです. Nắm vững cách diễn đạt điều lý ra phải và nên làm"
...
{{< audio-player src="/audio/n4/42_-_1_-_Kotoba.mp3" title="🔊 Nghe từ vựng bài 42" >}}
...
**Với danh từ:**
- きょうは どようび**のはずです**。→ Hôm nay lẽ ra phải là thứ bảy.
...
{{< audio-player src="/audio/n4/42_-_2_-_Bunkei.mp3" title="🔊 Nghe mẫu câu" >}}
{{< audio-player src="/audio/n4/42_-_3_-_Reibun.mp3" title="🔊 Nghe ví dụ" >}}
...
{{< audio-player src="/audio/n4/42_-_4_-_Kaiwa.mp3" title="🔊 Nghe hội thoại" >}}

## 4. Bài tập

**Câu 1:** Chọn đáp án đúng: この薬で病気が___。
a) 治るはずです b) 治るでしょう c) 治るべきです

{{< spoiler "Đáp án" >}}a) 治るはずです（có căn cứ cụ thể）{{< /spoiler >}}

**Câu 2:** Dịch sang tiếng Nhật: "Học sinh không nên hút thuốc."

{{< spoiler "Đáp án" >}}がくせいは たばこを すうべきではありません。{{< /spoiler >}}

**Câu 3:** Điền từ thích hợp: 約束の時間にもう着いている___です。

{{< spoiler "Đáp án" >}}はず{{< /spoiler >}}

**Câu 4:** Chọn cách dùng đúng của べき:
a) 来るべきです b) 来たべきです c) 来るのべきです

{{< spoiler "Đáp án" >}}a) 来るべきです{{< /spoiler >}}

**Câu 5:** Hoàn thành câu: 彼がそんなことをする___がありません。

{{< spoiler "Đáp án" >}}はず{{< /spoiler >}}

{{< audio-player src="/audio/n4/42_-_5_-_Renshuu_C1.mp3" title="🔊 Luyện tập C1" >}}
{{< audio-player src="/audio/n4/42_-_6_-_Renshuu_C2.mp3" title="🔊 Luyện tập C2" >}}
{{< audio-player src="/audio/n4/42_-_7_-_Renshuu_C3.mp3" title="🔊 Luyện tập C3" >}}
...
✨ Bài tiếp theo: [Bài 43: そうです・ようです — Truyền đạt thông tin](/jlpt/n4/bai-43-dentatsu-jouhou/)

## 🎧 Bài nghe kiểm tra

{{< audio-player src="/audio/n4/42_-_8_-_Mondai_1.mp3" title="🔊 問題1 — Nghe và trả lời" >}}

{{< audio-player src="/audio/n4/42_-_9_-_Mondai_2.mp3" title="🔊 問題2 — Nghe và trả lời" >}}
