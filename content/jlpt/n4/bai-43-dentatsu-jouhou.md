---
title: "Bài 43: そうです・ようです — Truyền đạt thông tin"
slug: "bai-43-dentatsu-jouhou"
date: 2023-02-26
description: "Học cách truyền đạt thông tin với そうです và ようです. Nắm vững cách diễn đạt thông tin nghe được và quan sát được"
...
{{< audio-player src="/audio/n4/43_-_1_-_Kotoba.mp3" title="🔊 Nghe từ vựng bài 43" >}}
...
- おもしろい**みたいです**。→ Có vẻ thú vị. (thông tục)
...
- かれは けっこん**したらしいです**。→ Nghe đồn anh ấy đã kết hôn.
- あした やすみ**らしいです**。→ Nghe đồn ngày mai nghỉ.
...
{{< audio-player src="/audio/n4/43_-_2_-_Bunkei.mp3" title="🔊 Nghe mẫu câu" >}}
{{< audio-player src="/audio/n4/43_-_3_-_Reibun.mp3" title="🔊 Nghe ví dụ" >}}
...
{{< audio-player src="/audio/n4/43_-_4_-_Kaiwa.mp3" title="🔊 Nghe hội thoại" >}}

## 4. Bài tập

**Câu 1:** Chọn đáp án đúng: 明日は雨が___（dự báo thời tiết）
a) 降るようです b) 降るそうです c) 降るらしいです

{{< spoiler "Đáp án" >}}b) 降るそうです（thông tin từ dự báo）{{< /spoiler >}}

**Câu 2:** Dịch sang tiếng Nhật: "Có vẻ như anh ấy bận rộn."

{{< spoiler "Đáp án" >}}かれは いそがしいようです。{{< /spoiler >}}

**Câu 3:** Điền từ thích hợp: この映画は面白い___です。（nghe người bạn nói）

{{< spoiler "Đáp án" >}}そう{{< /spoiler >}}

**Câu 4:** Chọn cách dùng đúng: 彼は学生＿＿＿です。（quan sát ngoại hình）
a) だそう b) のよう c) らしい

{{< spoiler "Đáp án" >}}b) のよう{{< /spoiler >}}

**Câu 5:** Hoàn thành câu: パーティーはとても楽しかった___です。

{{< spoiler "Đáp án" >}}そう（nghe người tham dự kể lại）{{< /spoiler >}}

{{< audio-player src="/audio/n4/43_-_5_-_Renshuu_C1.mp3" title="🔊 Luyện tập C1" >}}
{{< audio-player src="/audio/n4/43_-_6_-_Renshuu_C2.mp3" title="🔊 Luyện tập C2" >}}
{{< audio-player src="/audio/n4/43_-_7_-_Renshuu_C3.mp3" title="🔊 Luyện tập C3" >}}
...
✨ Bài tiếp theo: [Bài 44: ～すぎます・～やすい — Mức độ quá và dễ dàng](/jlpt/n4/bai-44-muckdo-yasui/)

## 🎧 Bài nghe kiểm tra

{{< audio-player src="/audio/n4/43_-_8_-_Mondai_1.mp3" title="🔊 問題1 — Nghe và trả lời" >}}

{{< audio-player src="/audio/n4/43_-_9_-_Mondai_2.mp3" title="🔊 問題2 — Nghe và trả lời" >}}