---
title: "Bài 44: ～すぎます・～やすい — Mức độ quá và dễ dàng"
slug: "bai-44-muckdo-yasui"
date: 2023-02-27
description: "Học cách diễn đạt mức độ quá với ～すぎます và tính dễ dàng với ～やすい/～にくい. Nắm vững cách biểu hiện mức độ và độ khó"
...
{{< audio-player src="/audio/n4/44_-_1_-_Kotoba.mp3" title="🔊 Nghe từ vựng bài 44" >}}
...
- **たべすぎ**は からだに よくありません。→ Ăn quá không tốt cho sức khỏe.
- **のみすぎ**に ちゅういして ください。→ Hãy cẩn thận không uống quá.

### 2.6 やすい/にくい thành tính từ

- **よみやすさ**が だいじです。→ Tính dễ đọc là quan trọng.
- この そふとうぇあの **つかいやすさ**が きにいっています。→ Tôi thích tính dễ sử dụng của phần mềm này.

{{< audio-player src="/audio/n4/44_-_2_-_Bunkei.mp3" title="🔊 Nghe mẫu câu" >}}
{{< audio-player src="/audio/n4/44_-_3_-_Reibun.mp3" title="🔊 Nghe ví dụ" >}}
...
{{< audio-player src="/audio/n4/44_-_4_-_Kaiwa.mp3" title="🔊 Nghe hội thoại" >}}

## 4. Bài tập

**Câu 1:** Chia động từ: このケーキを (食べる・すぎました)

{{< spoiler "Đáp án" >}}この ケーキを たべすぎました{{< /spoiler >}}

**Câu 2:** Dịch sang tiếng Nhật: "Quyển sách này dễ đọc."

{{< spoiler "Đáp án" >}}この ほんは よみやすいです。{{< /spoiler >}}

**Câu 3:** Chọn đáp án đúng: この字は___です。
a) 読みやすい b) 読みにくい c) 読みすぎ

{{< spoiler "Đáp án" >}}b) 読みにくい（dựa vào ngữ cảnh thường là khó đọc）{{< /spoiler >}}

**Câu 4:** Điền từ thích hợp: 今日は暑___ます。

{{< spoiler "Đáp án" >}}すぎ{{< /spoiler >}}

**Câu 5:** Hoàn thành câu: この道具は___やすいです。

{{< spoiler "Đáp án" >}}つかい（dễ sử dụng）{{< /spoiler >}}

{{< audio-player src="/audio/n4/44_-_5_-_Renshuu_C1.mp3" title="🔊 Luyện tập C1" >}}
{{< audio-player src="/audio/n4/44_-_6_-_Renshuu_C2.mp3" title="🔊 Luyện tập C2" >}}
{{< audio-player src="/audio/n4/44_-_7_-_Renshuu_C3.mp3" title="🔊 Luyện tập C3" >}}
...
✨ Bài tiếp theo: [Bài 45: ～ば・～なら — Điều kiện giả định](/jlpt/n4/bai-45-dieukien-kasutei/)
