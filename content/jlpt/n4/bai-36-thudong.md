---
title: "Bài 36: れる・られる — Thể bị động"
slug: "bai-36-thudong"
date: 2023-02-19
description: "Học thể bị động trong tiếng Nhật với れる・られる. Nắm vững cách chia và sử dụng thể bị động trong các tình huống khác nhau"
...
{{< audio-player src="/audio/n4/36_-_1_-_Kotoba.mp3" title="🔊 Nghe từ vựng bài 36" >}}
...
- よむ → よ**まれる** (được đọc/bị đọc)
- かく → か**かれる** (được viết/bị viết)
- はなす → はな**される** (được nói/bị nói về)
- よぶ → よ**ばれる** (được gọi/bị gọi)
- まつ → ま**たれる** (được chờ)

**Động từ nhóm II (1 âm):** る → られる
- たべる → たべ**られる** (được ăn/bị ăn)
- みる → み**られる** (được xem/bị xem)
...
{{< audio-player src="/audio/n4/36_-_2_-_Bunkei.mp3" title="🔊 Nghe mẫu câu" >}}
{{< audio-player src="/audio/n4/36_-_3_-_Reibun.mp3" title="🔊 Nghe ví dụ" >}}
...
{{< audio-player src="/audio/n4/36_-_4_-_Kaiwa.mp3" title="🔊 Nghe hội thoại" >}}

## 4. Bài tập

**Câu 1:** Chia thể bị động: 読む → ?

{{< spoiler "Đáp án" >}}読まれる（よまれる）{{< /spoiler >}}

**Câu 2:** Dịch sang tiếng Nhật: "Tôi bị bạn cười."

{{< spoiler "Đáp án" >}}ともだちに わらわれました。{{< /spoiler >}}

**Câu 3:** Chia thể bị động: 食べる → ?

{{< spoiler "Đáp án" >}}食べられる（たべられる）{{< /spoiler >}}

**Câu 4:** Dịch sang tiếng Nhật: "Cuốn sách này được viết bởi một tác giả nổi tiếng."

{{< spoiler "Đáp án" >}}この ほんは ゆうめいな さっかに かかれました。{{< /spoiler >}}

**Câu 5:** Chọn trợ từ đúng: わたしは いもうと（　）おこられました。
a) を b) に c) で

{{< spoiler "Đáp án" >}}b) に{{< /spoiler >}}

{{< audio-player src="/audio/n4/36_-_5_-_Renshuu_C1.mp3" title="🔊 Luyện tập C1" >}}
{{< audio-player src="/audio/n4/36_-_6_-_Renshuu_C2.mp3" title="🔊 Luyện tập C2" >}}
{{< audio-player src="/audio/n4/36_-_7_-_Renshuu_C3.mp3" title="🔊 Luyện tập C3" >}}
...
✨ Bài tiếp theo: [Bài 37: Thể sai khiến](/jlpt/n4/bai-37-shieki/)

## 🎧 Bài nghe kiểm tra

{{< audio-player src="/audio/n4/36_-_8_-_Mondai_1.mp3" title="🔊 問題1 — Nghe và trả lời" >}}

{{< audio-player src="/audio/n4/36_-_9_-_Mondai_2.mp3" title="🔊 問題2 — Nghe và trả lời" >}}