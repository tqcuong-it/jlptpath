---
title: "Bài 50: 総復習 — Tổng kết N4"
slug: "bai-50-tongket-n4"
date: 2023-03-05
description: "Tổng kết toàn bộ chương trình N4. Ôn tập ngữ pháp, từ vựng, Kanji và chuẩn bị cho kỳ thi JLPT N4"
...
{{< audio-player src="/audio/n4/50_-_2_-_Bunkei.mp3" title="🔊 Nghe mẫu câu" >}}
{{< audio-player src="/audio/n4/50_-_3_-_Reibun.mp3" title="🔊 Nghe ví dụ" >}} N4 theo chủ đề
...
**Cảm xúc (20 chữ):**
喜、怒、哀、楽、愛、悲、心、情、感、気、思、考、意、望、希、願、夢、想、念、恋

**Công việc (25 chữ):**
会、社、仕、事、業、職、員、働、給、料、金、銭、売、買、客、商、店、品、物、貨、労、務、任、責、役

**Học tập (20 chữ):**
学、習、勉、強、研、究、知、識、覚、忘、理、解、説、明、問、答、試、験、合、格

**Thời gian/Trạng thái (25 chữ):**
始、終、続、止、速、遅、早、晩、急、忙、暇、便、利、困、難、易、簡、単、複、雑、完、成、失、敗、功
...
日本語を___ように、毎日練習しています。
a) 話す b) 話せる c) 話した

{{< spoiler "Đáp án" >}}b) 話せる（để có thể nói được）{{< /spoiler >}}

**Câu 2:** Chọn cách nói đúng:
a) 先生は教室にいらっしゃいます
b) 私は先生にお会いいたします  
c) Cả hai đều đúng

{{< spoiler "Đáp án" >}}c) Cả hai đều đúng{{< /spoiler >}}

**Câu 3:** Hoàn thành câu: 雨が降れば、家に___。
a) います b) いましょう c) いました

{{< spoiler "Đáp án" >}}b) いましょう（điều kiện tương lai）{{< /spoiler >}}

### 6.2 Từ vựng và Kanji
...
{{< spoiler "Đáp án" >}}a) じゅうような かいぎ{{< /spoiler >}}

**Câu 5:** Chọn từ đồng nghĩa với 嬉しい:
a) 楽しい b) 喜ぶ c) 幸せ

{{< spoiler "Đáp án" >}}a) 楽しい（cùng về cảm xúc tích cực）{{< /spoiler >}}
...
1. **Thực hành hàng ngày** - 30 phút/ngày tốt hơn 3 giờ/tuần
2. **Sử dụng tiếng Nhật thực tế** - Xem anime, đọc manga, nghe nhạc
3. **Không sợ sai** - Học từ lỗi sai là cách học nhanh nhất
4. **Kiên trì** - N4 không khó nhưng cần thời gian

### 8.2 Sau N4 làm gì?

🎯 **JLPT N3:** Nâng cao ngữ pháp, từ vựng chuyên ngành
📚 **Đọc sách tiếng Nhật:** Light novel, tin tức, blog
💬 **Giao tiếp thực tế:** Tìm partner, tham gia cộng đồng
🎌 **Văn hóa Nhật:** Hiểu sâu hơn về xã hội, lịch sử
...
{{< audio-player src="/audio/n4/50_-_8_-_Mondai_1.mp3" title="🔊 問題1 — Nghe và trả lời" >}}

{{< audio-player src="/audio/n4/50_-_9_-_Mondai_2.mp3" title="🔊 問題2 — Nghe và trả lời" >}}
