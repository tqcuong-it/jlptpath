...
|---------|-----|-------|---------|
| デジタル化 | デジタルか | số hóa | danh từ/動từ |
| 透明性 | とうめいせい | tính minh bạch | danh từ |
| マイナンバー | マイナンバー | số cá nhân | danh từ |
| オンライン申請 | オンラインしんせい | đăng ký trực tuyến | danh từ |
| 利便性 | りべんせい | tính tiện lợi | danh từ |
| セキュリティ | セキュリティ | bảo mật | danh từ |
| プライバシー | プライバシー | quyền riêng tư | danh từ |
| 電子政府 | でんしせいふ | chính phủ điện tử | danh từ |
| システム統合 | システムとうごう | tích hợp hệ thống | danh từ |
| デジタルリテラシー | デジタルリテラシー | khả năng số | danh từ |
| 組織文化 | そしきぶんか | văn hóa tổ chức | danh từ |
| 抵抗感 | ていこうかん | cảm giác chống đối | danh từ |
| パブリックコメント | パブリックコメント | ý kiến công chúng | danh từ |
...
### Câu hỏい 1: 行政のデジタル化によって期待されているものは何ですか？
A) 職員数の削減
B) 効率的で透明性の高い政府サービスの提供
C) 予算の増額
D) 新しい施設の建設

### Câu hỏい 2: 電子政府推進における重要な課題は何ですか？
A) 電力供給の安定化
B) 各省庁間でのシステム統合
C) 新庁舎の建設
D) 職員の給与改善

### Câu hỏი 3: オンライン投票やパブリックコメントシステムで懸念されている問題は何ですか？
A) システムの複雑さ
B) デジタル格差による参加機会の不平等
C) 運営コストの高さ
D) 法的制約の多さ

### Câu hỏি 4: データ活用による政策立案において課題となっているのは何ですか？
A) データ収集の困難さ
B) アルゴリズムの透明性や説明責任の確保
C) 分析技術者の不足
D) システムの処理能力不足

### Câu hỏי 5: デジタル政府の成功のために不可欠とされているのは何ですか？
A) 最新技術の導入のみ
B) 予算の大幅増額
C) 技術的課題解決・国民の信頼獲得・持続可能なシステム運営体制構築
D) 職員の完全置き換え

{{< spoiler "Đáp án" >}}
1. **B** — 効率的で透明性の高い政府サービスの提供が期待されている
2. **B** — 各省庁間でのシステム統合が重要な課題となっている
3. **B** — デジタル格差により参加機会に不平等が生じる恐れがある
