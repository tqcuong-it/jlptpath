...
### Câu hỏি 1: 学際的研究の必要性が高まっている背景は何ですか？
A) 研究費の減少
B) 現代科学の複雑化と専門分化による複合的課題の出現
C) 研究者数の不足
D) 国際競争の激化

### Câu hỏই 2: 自然科学系と人文・社会科学系分野の統合で困難な要因は何ですか？
A) 研究設備の不足
B) 認識論的な深淵の存在
C) 言語の違い
D) 地理的距離

### Câu hỏই 3: 気候変動研究の学際性で課題となっているのは何ですか？
A) 研究資金の確保
B) 時間的・空間的スケールの相違と不確実性概念の解釈の多様性
C) 研究者の専門性不足
D) 国際協力の欠如

### Câu hỏি 4: 学際的研究の制度的課題として指摘されているのは何ですか？
A) 技術的な制約
B) 既存の学問分野を基盤とした組織や評価システムの硬直性
C) 研究倫理の問題
D) データ保護の困難

### Câu hỏয 5: 学際的研究の発展に必要とされているのは何ですか？
A) 個別研究者の努力のみ
B) 技術革新のみ
