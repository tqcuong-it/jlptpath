...
{{< spoiler "Đáp án" >}}
1. **B** — 一つの国だけでは解決できない問題が増えている (Các vấn đề một quốc gia không thể giải quyết đang gia tăng)
2. **B** — ODAを通じて学校や病院の建設、技術指導 (Thông qua ODA xây trường, bệnh viện, hướng dẫn kỹ thuật)
3. **C** — 対等な立場での協力関係を築くこと (Xây dựng quan hệ hợp tác bình đẳng)
{{< /spoiler >}}
